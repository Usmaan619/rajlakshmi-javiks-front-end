      ...
      <div className="background-color-light-grayish-yellow py-3">
        <div className="container mb-5 pb-5">
          ...
          <div className="mt-4 mb-5 pb-5">
            <ul className="term-page">
              <li className="font-size-16 inter-font-family-500 my-4 py-3">
                ...
                of domain name https://rajlakshmijaviks.com ('Website'), including the
                related mobile site and mobile application (hereinafter referred
                to as 'Platform').
              </li>
              <li className="font-size-16 inter-font-family-500 my-4 py-3">
                The Platform is owned by RAJLAKSHMI JAVIKS IN, a company
                incorporated under the Companies Act, 1956 with its registered
                office at 11 Rajlakshmi Javiks International Manishbag Colony
                Indore Near Sandeep Electricals and Decorators Indore India
